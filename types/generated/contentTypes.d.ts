...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    orders: Schema.Attribute.Relation<'oneToMany', 'api::commande.commande'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiCategorieDeProduitCategorieDeProduit
  extends Struct.CollectionTypeSchema {
  collectionName: 'categorie_de_produits';
  info: {
    singularName: 'categorie-de-produit';
  ...
  attributes: {
    name: Schema.Attribute.String;
    products: Schema.Attribute.Relation<'manyToMany', 'api::produit.produit'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categorie-de-produit.categorie-de-produit'
    >;
  };
}
...
export interface ApiProduitProduit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    stock: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    devStripeProductId: Schema.Attribute.String &
      Schema.Attribute.Private &
      Schema.Attribute.Unique;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::categorie-de-produit.categorie-de-produit': ApiCategorieDeProduitCategorieDeProduit;
